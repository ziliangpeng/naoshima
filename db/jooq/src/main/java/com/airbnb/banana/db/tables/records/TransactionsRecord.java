...
public class TransactionsRecord extends UpdatableRecordImpl<TransactionsRecord> implements Record4<Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -1143844975;
    ...
    /**
     * Setter for <code>Transactions.sender</code>.
     */
    ...
    /**
     * Getter for <code>Transactions.sender</code>.
     */
    ...
    /**
     * Setter for <code>Transactions.receiver</code>.
     */
    ...
    /**
     * Getter for <code>Transactions.receiver</code>.
     */
     ...
     */
    @Override
    public TransactionsRecord values(Integer value1, Integer value2, Integer value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionsRecord(Integer id, Integer sender, Integer receiver, Integer amount) {
        super(Transactions.TRANSACTIONS);
